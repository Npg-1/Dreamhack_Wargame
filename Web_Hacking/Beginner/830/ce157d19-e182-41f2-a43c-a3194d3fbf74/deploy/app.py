        ...
        if request.args.get("prev_step_num"):
            try:
                ...
                if prev_step_num == str(step1_num):
                    ...
                    return render_template("step2.html", prev_step_num = step1_num, hidden_num = step2_num, text = "여기1")
            except:
                return render_template("step2.html", text="여기2")
        return render_template("step2.html", text="여기3")
        ####

    else: 
        return render_template("step2.html", text="여기4")
